...
class Questions_and_Answers:
    ...
    def __init__(self, tablename="questions_answers", question="question", correct_answer="correct_answer", wrong_answer1="wrong_answer1", wrong_answer2="wrong_answer2", wrong_answer3 = "wrong_answer3"):
    ...
    def get_questions_and_answers(self):
        ...
        """
        conn = sqlite3.connect('database_qa.db')
        str1 = "select * from questions_answers;"
        print(str1)
